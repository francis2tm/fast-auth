...
import type { EmailConfirmGetData, EmailConfirmGetErrors, EmailConfirmGetResponses, EmailConfirmSendData, EmailConfirmSendErrors, EmailConfirmSendResponses, MeGetData, MeGetErrors, MeGetResponses, PasswordForgotData, PasswordForgotErrors, PasswordForgotResponses, PasswordResetData, PasswordResetErrors, PasswordResetResponses, SignInData, SignInErrors, SignInResponses, SignOutData, SignOutErrors, SignOutResponses, SignUpData, SignUpErrors, SignUpResponses } from './types.gen';
 ...
 */
export const emailConfirmGet = <ThrowOnError extends boolean = false>(options: Options<EmailConfirmGetData, ThrowOnError>) => {
    return (options.client ?? client).get<EmailConfirmGetResponses, EmailConfirmGetErrors, ThrowOnError>({
 ...
 */
export const emailConfirmSend = <ThrowOnError extends boolean = false>(options: Options<EmailConfirmSendData, ThrowOnError>) => {
    return (options.client ?? client).post<EmailConfirmSendResponses, EmailConfirmSendErrors, ThrowOnError>({
 ...
 */
export const meGet = <ThrowOnError extends boolean = false>(options?: Options<MeGetData, ThrowOnError>) => {
    return (options?.client ?? client).get<MeGetResponses, MeGetErrors, ThrowOnError>({
        url: '/auth/me',
        ...options
    });
};
 ...
 * Always returns success to prevent email enumeration attacks.
 */
export const passwordForgot = <ThrowOnError extends boolean = false>(options: Options<PasswordForgotData, ThrowOnError>) => {
    return (options.client ?? client).post<PasswordForgotResponses, PasswordForgotErrors, ThrowOnError>({
...
export const passwordReset = <ThrowOnError extends boolean = false>(options: Options<PasswordResetData, ThrowOnError>) => {
    return (options.client ?? client).post<PasswordResetResponses, PasswordResetErrors, ThrowOnError>({
