...
pub fn email_validate_normalize(email: &str) -> Result<String, AuthError> {
...
mod tests {
    ...
    #[test]
    fn test_valid_email() {
        let result = email_validate_normalize("user@example.com");
    ...
    fn test_rejects_invalid_no_at() {
        let result = email_validate_normalize("userexample.com");
        assert!(result.is_err());
    }

    #[test]
    fn test_rejects_invalid_no_domain() {
        let result = email_validate_normalize("user@");
        assert!(result.is_err());
    }

    #[test]
    fn test_rejects_invalid_no_local() {
        let result = email_validate_normalize("@example.com");
        assert!(result.is_err());
    }
    ...
    fn test_rejects_empty() {
        let result = email_validate_normalize("");
        assert!(result.is_err());
    }
